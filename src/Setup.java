		...
		Util.lineBreak();
	 	...
	 	switch(choice)
	 	{
	 		...
	 		case 4:
	 			...
	 			SpecialAttack ravFirst = new SpecialAttack("Ravager's Genesis","Ravager",25,25,-1,0,5,1.25);
	 			SpecialAttack ravSecond = new SpecialAttack("Beginners' Luck","Ravager",10,15,-1,0,40,10);
	 		...
	 		case 5:
	 			...
	 			SpecialAttack relFirst = new SpecialAttack("Reliever's Genesis","Reliever",12,15,-1,0,5,1.25);
