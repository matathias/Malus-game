public class Story
{
	...
	public static void desert(boolean d) //pre-menu choice COMPLETE
	{
		...
		{
			Util.lineBreak();
			System.out.println("You arrive at the desert past the town with a level of dread;\ndeserts are far from comfortable environments, after all.");
			System.out.println("But this is the beginning of the adventure;\nsurely other locales will be more welcoming?");
			System.out.println("Either way, you set your jaw and look forward,\nready to defeat anything that comes your way!");
			Util.skitPause();
			placeQuoteCounter++;
		}
		else if(d)
	...
	public static void desertBoss() //intro to desert boss COMPLETE
	{
		if(!desBoss)
		{
			...
			System.out.println("Excited to finally be past the horrid desert heat, you speed up your pace,\nhoping that you at least won't get dirt in your eyes on the plains.");
			System.out.println("However, before you can get very far a sudden sandstorm whips up,\nnearly blinding you and concealing the plains behind a curtain of sand.");
			System.out.println("You quickly adjust to the sand, though the first thing you spot\nis a floating, sand-colored stone.");
			System.out.println("Even though it has no eyes, it seems as if it's glaring down\nat you contemptuously, laughing at your plight.");
			System.out.println("Obviously, it must be the source of the sandstorm!\n...though even if it isn't, destroying it could offer some solace.");
	...
	public static void desertBossEmergency() //desert boss goes into emergency mode COMPLETE
	{
		...
		System.out.println("Immediately after doing so the sand storm around you intensifies.\nIt would appear that you've succeeded in making it angry!");
	...
	{
		Util.lineBreak();
		System.out.println("With a final blow you shatter the Sand Stone to millions of tiny pieces,\neach disappearing into the very sandstorm the stone conjured.");
		System.out.println("Now that the Sand Stone is no more, the sandstorm begins to subside -\nsoon, the plains become visible once again.");
		System.out.println("And with a closer look, you see a forest beyond the plains,\nand a distant mountain range beyond that.");
		System.out.println("It looks like it could be bothersome to trek through all that terrain,\nbut you can't shake off this feeling of lurking evil.");
	...
	{
		Util.lineBreak();
		System.out.println("Realizing that you aren't strong enough to defeat the Sand Stone,\nyou turn and high-tail it out of there.");
	...
	public static void plains(boolean p) //pre-menu stuff COMPLETE
	{
		...
		{
			Util.lineBreak();
			System.out.println("Finally, you step onto ground that isn't unstable, uncomfortable sand.\nYou breath a sigh of relief; even the air is more comfortable.");
			System.out.println("But the sun is still an issue - there's no cover or shade in the Plains.\nAnd the enemies are bound to be more difficult as well.");
	...
	public static void plainsBoss() //intro to plains boss COMPLETE
	{
		if(!plaBoss)
		{
			...
			System.out.println("While not exactly overjoyed,\nyou're certainly happy that the next stage of your adventure is near complete.");
			System.out.println("However, before you're able to reach the treeline\nthe grass beneath you suddenly becomes very stiff and sharp;");
			System.out.println("With a yelp of pain, you leap back, glaring at the offending plants.\nSoon, though, the real culprit reveals itself: a levitating green stone.");
			System.out.println("It bears a remarkable resemblance to the Sand Stone...\nmaybe by destroying it, you'll be able to access the forest!");
	...
	{
		System.out.println("Before the Grass Stone attacks again,\nit seems to almost rear up into the air.");
		System.out.println("Immediately after doing so the grass around you is uprooted\nand rises into the air, surrounding the Grass Stone.");
	...
	{
		Util.lineBreak();
		System.out.println("With a final blow you shatter the Grass Stone to a million tiny pieces,\neach disappearing into the grass it once controlled.");
		System.out.println("Finally the grass settles, allowing you passage over the remaining hills\nwithout your feet being impaled.");
		System.out.println("You cautiously cross the remaining distance (in case there are any more enemies)\nbut reach the forest unharmed.");
		System.out.println("This close to the forest, it's impossible to see anything past it -\nbut you know that the mountains are there, and beyond them, a great evil.");
	...
	{
		Util.lineBreak();
		System.out.println("Realizing that you aren't strong enough to defeat the Grass Stone,\nyou quickly turn tail and leave.");
	...
	{
		Util.lineBreak();
		System.out.println("After recieving a critical hit you finally realize\nthat you aren't strong enough to fight the Grass Stone.");
	...
	public static void forest(boolean f) //pre-menu stuff COMPLETE
	{
		...
		{
			Util.lineBreak();
			System.out.println("So you've finally made it to the shade of the forest.\nThe sun's no longer an issue; no more sunburns for you!");
			System.out.println("However, this forest looks a tad spookier on the inside than the out -\nthere's bound to be tons of enemies here.");
	...
	public static void forestBoss() //intro to forest boss COMPLETE
	{
		...
		{
			Util.lineBreak();
			System.out.println("After dodging past the next tree, you spot a sliver of light,\nbrighter than any location within the forest.");
			System.out.println("You conclude that it must be the treeline - you're at a higher altitude\nthan when you first entered the forest, anyway.");
			System.out.println("However, before you can get much closer to the light all of the leaves\naround you suddenly come to life.");
			System.out.println("Swirling around you, they begin to lacerate your skin one by one;\nnot wanting to die by 1000 papercuts, you quickly jump out of the vortex.");
			System.out.println("Now outside of the leaves, you see a floating, dark green stone behind it.\nIt looks rather similar to the Sand and Grass Stones.");
	...
	public static void forestBossEmergency() //COMPLETE
	{
		...
		System.out.println("Immediately after doing so the leaf storm in front of you intensifies.\nIt would appear that you've succeeded in making it angry!");
		System.out.println("But you can't lose now; you've almost won!");
		Util.skitPause();
	}
	...
	{
		Util.lineBreak();
		System.out.println("Recognizing the gap in capability between you and the Leaf Stone,\nyou quickly pull out, staging a tactical retreat.");
	...
	{
		Util.lineBreak();
		System.out.println("After receiving a critical hit you realize that you\nsimply aren'tstrong enough to take on the Leaf Stone.");
	...
	public static void mountains(boolean m) //pre-menu stuff COMPLETE
	{
		...
		{
			Util.lineBreak();
			System.out.println("Now in the mountains, you notice a certain biting coolness\nthat wasn't present before (and certainly not in the desert).");
			System.out.println("You may not have the shade that the forest offered,\nbut the lack of heat makes up for it.");
	...
	{
		System.out.println("Before the Blizzard Stone attacks again,\nit seems to almost rear up into the air.");
		System.out.println("Immediately after doing so the snow storm around you intensifies.\nIt would appear that you've succeeded in making it angry!");
		System.out.println("But you can't lose now; you've almost won!");
		Util.skitPause();
	}
	...
	{
		Util.lineBreak();
		System.out.println("You land a final critical hit on the Blizzard Stone,\nshattering it into a million pieces,\neach disappearing into the Blizzard it created.");
		System.out.println("Slowly, the weather calms down, until you can once again see the sky -\nand also the village.");
		System.out.println("As you approach the village, you think back to the four Stones you've defeated:\nSand, Grass, Leaf, and Blizzard.");
		System.out.println("Is there a connection? You believe that there must be one,\nbut what it is, you aren't quite sure.");
	...
	{
		Util.lineBreak();
		System.out.println("The gap in ability between you and the Blizzard Stone is simply too large.\nYou quickly initiate a retrograde advance.");
	...
	public static void volcano(boolean v) //pre-menu stuff COMPLETE
	{
		...
		{
			Util.lineBreak();
			System.out.println("You near the base of the volcano and can already feel the heat;\nit's far more uncomfortable than the desert.");
			System.out.println("You aren't sure what you'll find here - or even what you're doing here -\nbut you can sense the evil even stronger than before.");
	...
	public static void volcanoBoss() // intro to volcano boss COMPLETE
	{
		...
		{
			Util.lineBreak();
			System.out.println("As you walk around the base of the Volcano you spot a cave\nthat isn't flooded with lava. Curious, you begin to approach.");
			System.out.println("\"Halt right there!\"");
			System.out.println("Startled, you pause and look about. Your eyes soon land on an armored\nindividual to your side, holding a gun in your direction!");
			System.out.println("The sense of danger and evil you felt at the beginning of your adventure\nsuddenly overwhelms you. Certainly, this person is the source!");
			System.out.println("But at your current ability level there's no way you could defeat him.\nThough any further thought is cut off as the individual begins to speak.");
			System.out.println("\"Ah, another one of those hardy adventure types, hoping to defeat me,\nis that it?\" he smirks, \"Pft. As if I could lose to the likes of you!\"");
			System.out.println("You take a step back; if this man intends to attack you,\nthen you intend to retreat. As fast as humanly possible.");
			System.out.println("\"Hmm... you're scared of me. I can see that you're intelligent enough\nto recognize my power,\" the man comments, \"...perhaps I won't kill you now.\"");
			System.out.println("He then takes a step back and taps his wrist -\nit looks as if he's typing something - and then looks back to you.");
			System.out.println("\"Instead...\" he sneers, as a giant, flying robot swoops down behind him,\n\"I'll pit you against this Boss Class Aerial 'Bot.\"");
			System.out.println("Suddenly, the ground below you shudders and begins rising into the air,\nrevealing itself to be a large, levitating metal platform!");
			System.out.println("With apprehension you turn to look down at the man, only to see the robot\nflying up at you and the man shouting after it:");
	...
	{
		System.out.println("With a mechanical screech the Wyvern launches into the air,\ncoming to a stop and hovering a fair distance over the platform.");
		System.out.println("It then pulls its tail down between its legs, as if its pointing at you,\nand then - a spike suddenly appears on the tip!");
		System.out.println("For it to pull a trick out of its sleeve...\nyou must be fairly close to defeating it.");
	...
	{
		Util.lineBreak();
		System.out.println("\"Ha ha ha, that's what I thought!\" Malus shouts after your retreating form,\n\"You aren't strong enough to face me! At all!\"");
	...
	{
		Util.lineBreak();
		System.out.println("\"AH ha ha ha ha!!\" Malus laughs loud and long as you fall to the ground,\nalmost every bone in your body broken.");
		System.out.println("\"You aren't strong enough to face me, and you never will be.\"\nHe sneers, and then turns away with the Wyvern.");
		System.out.println("\"I'll let you live, for now.\nMaybe you'll serve as a lesson for others who ignorantly wish to face me!\"");
	...
	public static void caverns(boolean c) //pre-menu stuff COMPLETE
	{
		...
		{
			Util.lineBreak();
			System.out.println("As you walk through the cavern under the volcano,\nyou note that it isn't becoming hot. In fact, it's actually getting colder.");
			System.out.println("That defeats all logic...\ntechnically, you should have reached a lava flow by now!");
			System.out.println("You continue down the caves... and a thought pops into your head:\nWhat if this geographic phenomonon was created by Malus?");
			System.out.println("If so, then he must have a great deal of resources and time on his side...\nbut it also means that you're likely close to his base!");
			System.out.println("It's time to up the ante. You resolutely decide to blast through\nthe caves and find Malus' base, and then stop him!");
	...
	{
		System.out.println("The Cerberus rears up and lets loose an electronic roar;\nupon doing so you can see various small internal fires.");
	...
	{
		Util.lineBreak();
		System.out.println("After suffering a final critical blow the Cerberus shuts down\ncatastrophically... that is, it explodes.");
	...
	{
		Util.lineBreak();
		System.out.println("The way this battle is going, you'll never win.\nRecognizing this, you quickly pull out.");
	...
	public static void cavernsBossLose() //player loses to the boss COMPLETE
	{
		...
		System.out.println("Your body broken, you somehow manage to disengage from the Cerberus\nand begin your long, painful trek back to the village.");
	...
	public static void base(boolean f, boolean u, boolean l, boolean m, boolean b) //pre-menu stuff (baseFac,baseUrb,baseLab,baseMil,baseFin) COMPLETE
	{
		...
		{
			Util.lineBreak();
			System.out.println("You emerge from the caverns to find yourself in a completely unknown locale.\nEverything around you looks industrial...");
			System.out.println("\"Ah, so you finally arrived!\"");
			System.out.println("You look up, though you have no need -\nyou already know the identity of the speaker.");
			System.out.println("\"I must say, well done!\" Malus smirks from his position atop a nearby building,\n\"Defeating both the Wyvern and the Cerberus... impressive!\"");
			System.out.println("\"But you still aren't at my level! And if you don't defeat me\nwithin the next 24 hours... then you never will be!!\"");
			System.out.println("He then jumps into the air and engages his jet pack,\nflying backward into the industrial complex.\n\"Good luck reaching me before then!\"");
			System.out.println("You watch him leave, and then what he says hits you.\n24 hours? What could possibly happen after that...?");
			System.out.println("Well, you at least know you don't want to find out.\nAll you know is that you're standing at the entrance to Malus' domain...");
	...
	public static void baseFactoryBoss() //intro to factory boss COMPLETE
	{
		...
		{
			Util.lineBreak();
			System.out.println("After fighting through Malus' construction and production\nfacilities you find yourself in a large hanger.");
			System.out.println("You suspect that something is amiss... and sure enough,\na large door in the back opens to reveal a large mech!");
			System.out.println("It appears to almost be a cross between a spider and a dog...\nbut its appearance doesn't matter. You plan to defeat it no matter what!");
	...
	{
		System.out.println("The Bug Crawler lets loose a metallic roar and then flaps its wings strongly,\napparently attempting to put out the many fires on its wings.");
	...
	{
		System.out.println("Suddenly the Bug Crawler dives down toward the ground,\ncoming to a stop just before it hits.");
		System.out.println("It lands with a metallic crash and then discards its wings;\nsurprised, you back off a bit, not sure how to react.");
	...
	{
		Util.lineBreak();
		System.out.println("The Bug Crawler collapses to the ground, overloading and shutting down\nafter the beat-down you offered it.");
	...
	{
		Util.lineBreak();
		System.out.println("After receiving another critical blow you finally realize\nthat you simply can't beat the Bug Crawler.");
	...
	public static void baseUrbanBoss() //intro to urban boss COMPLETE
	{
		...
		{
			Util.lineBreak();
			System.out.println("After walking through what may be the most un-populated city you've ever seen,\nyou find yourself in a large parking lot surrounding by buildings.");
			System.out.println("You suspect that something is amiss... and sure enough, a large,\nnearby garage door opens to reveal a large mech!");
			System.out.println("It doesn't appear too impresive, but it certainly has guns equipped...\nthough that doesn't matter. You plan to defeat it no matter what!");
			System.out.println("And once you do... you'll be just one step closer to Malus!");
			Util.skitPause();
			urbBoss = true;
		}
	...
	{
		System.out.println("Seemingly fed up with its attacks failing, the Civil Control Mech\ntakes a step back and then opens a hidden hatch on its front side.");
	...
	{
		Util.lineBreak();
		System.out.println("The Civil Control Mech crumbles to the ground,\noverloading and shutting down permanently.");
		System.out.println("That's one of Malus' mechs defeated... time to move onward!");
		Util.skitPause();
	}
	...
	{
		Util.lineBreak();
		System.out.println("After receiving another painful shock you finally realize that\nyou simply can't beat the Civil Control Mech.");
	...
	{
		System.out.println("After receiving sufficient damage much of the Mantis Crawler's\nbulkier armor suddenly falls off.");
		System.out.println("On first thought, this seems like a Godsend,\nbut in actuallity it allows the Mantis to move at much higher speeds!");
	...
	{
		Util.lineBreak();
		System.out.println("The Prototype Mantis Crawler crashes to the ground,\nits systems failing and causing a catastrophic overload.");
		System.out.println("That's one of Malus' mechs defeated... time to move onward!");
		Util.skitPause();
	}
	...
	{
		Util.lineBreak();
		System.out.println("After receiving another painful slash you finally realize that\nyou simply can't beat the Prototype Mantis Crawler.");
	...
	{
		System.out.println("The Insecti Crawler takes a step back and then\nlets loose a metallic roar as some of its armor falls off.");
		System.out.println("It then reveals a new, more powerful set of weapons,\nand turns to face you, all of them actively targetting you!");
	...
	{
		System.out.println("Suddenly the Insecti Crawler seems to flare up -\nif it could properly display emotion then 'enraged' would be the most applicable.");
		System.out.println("It then pulls out a weapon that you haven't seen before...\nit appears to be a cannon, but unlike any other you've seen.");
		System.out.println("But wait... you remember reading something about a new-fangeld\n'black hole cannon' that scientists were working on... could this really be it?");
		System.out.println("It looks like what you imagined a Black Hole Cannon to look like...\nbut surely such a thing is impossible-!");
	...
	{
		Util.lineBreak();
		System.out.println("The Insecti Crawler fails and its Prototype Black Hole Cannon overloads,\ncausing the entire mech to implode on itself.");
		System.out.println("That's one of Malus' mechs defeated... time to move onward!");
		Util.skitPause();
	}
	...
	{
		Util.lineBreak();
		System.out.println("After receiving another critical blow you finally realize that\nyou simply can't beat the Insecti Crawler.");
	...
	public static void malusBoss() //intro to Malus as a boss COMPLETE
	{
		...
		{
			Util.lineBreak();
			System.out.println("You've fought through scorching desert... rolling plains...\nleafy forest... freezing mountains...\na burning volcano... dank caverns...");
			System.out.println("You reached Malus' base... you cleared out most of his forces...\nYou destroyed his four main guardian mechs...");
		...
		{
			Util.lineBreak();
			System.out.println("\"Decided that you actually have the guts to try and fight me?\"\nMalus sneers, \"You've only got so much time!\"");
	...
	{
		Util.lineBreak();
		System.out.println("\"Well, that was fun!\" Malus exclaims, strutting over to stand\nover your broken form, \"But... not enough!\"");
		System.out.println("\"I'll go ahead and let you live, since I'm bored...\nbut when you come back you had better be sure to be stronger!\"");
